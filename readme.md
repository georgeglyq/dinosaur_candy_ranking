...
Our App will allow the user to pick an ingredient factor category (ex: chocolate, fruity), and output the highest rating candy that contains that factor <br />
...
and can hover over any point to see what candy the point represents. <br />
...
in each column depending on if the candy contains that factor or not. It also displays the sugar content percentage of the chosen candy. <br />
...
ingredients and if the sugar percentage is within a 5% range of the chosen candy. <br />
